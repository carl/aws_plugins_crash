...
public:
    ...
    */
    ...
    void setCallbackHandle(void* callbackHandle);
    void SetOnAudioUnitBeforeRecvAudioRenderCallback(pf_on_audio_unit_before_recv_audio_rendered_t callback);
    void SetOnAudioUnitBeforeRecvAudioMixedCallback(pf_on_audio_unit_before_recv_audio_mixed_t callback);
    void SetOnAudioUnitAfterCapture(pf_on_audio_unit_after_capture_audio_read_t callback, pf_on_audio_unit_started_t audioStart, pf_on_audio_unit_stopped_t audioStop, pf_on_audio_unit_before_capture_audio_sent_t beforeAudioSent);
