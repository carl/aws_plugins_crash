...
public:
    ...
    */
     ...
     * \remarks Audio transmission changes take effect immediately in all channels this user is already connected to. The changes also affect future channels joined as follows:
