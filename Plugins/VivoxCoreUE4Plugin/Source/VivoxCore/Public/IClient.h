...
public:
   ...
   /*Implement this to check if Client is already Initialised*/
    ...
    virtual VivoxCoreError SetAudioOutVolume(int volume) = 0;
    
    virtual VivoxCoreError SetAudioInVolume(int volume) = 0;
};
