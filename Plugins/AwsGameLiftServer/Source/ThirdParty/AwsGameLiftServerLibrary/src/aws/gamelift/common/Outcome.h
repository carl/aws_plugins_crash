...
namespace Aws
{
    namespace GameLiftServer
    {
        ...
        */
        ...
        typedef Outcome<void*, GameLiftServerError> GenericOutcome;
        typedef std::future<GenericOutcome> GenericOutcomeCallable;
        typedef Outcome<std::string, GameLiftServerError> AwsStringOutcome;
        typedef Outcome<long, GameLiftServerError> AwsLongOutcome;
#else
        public:
        ...
        typedef Outcome<void*, GameLiftServerError> GenericOutcome;
        typedef Outcome<const char*, GameLiftServerError> AwsStringOutcome;
        typedef Outcome<long, GameLiftServerError> AwsLongOutcome;
#endif

        typedef Outcome<Aws::GameLiftServer::Server::Model::DescribePlayerSessionsResult, GameLiftServerError> DescribePlayerSessionsOutcome;
        typedef Outcome<Aws::GameLiftServer::Server::Model::StartMatchBackfillResult, GameLiftServerError> StartMatchBackfillOutcome;
        typedef Outcome<Aws::GameLiftServer::Server::Model::GetComputeCertificateResult, GameLiftServerError> GetComputeCertificateOutcome;
        typedef Outcome<Aws::GameLiftServer::Server::Model::GetFleetRoleCredentialsResult, GameLiftServerError> GetFleetRoleCredentialsOutcome;
    } // namespace GameLiftServer
} // namespace Aws
