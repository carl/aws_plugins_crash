...
namespace Internal {
    ...
    public:
        ...
        inline const Aws::GameLiftServer::Server::LogParameters GetLogParameters() const {
        ...
        inline void SetLogParameters(const Aws::GameLiftServer::Server::LogParameters& logParameters) {
