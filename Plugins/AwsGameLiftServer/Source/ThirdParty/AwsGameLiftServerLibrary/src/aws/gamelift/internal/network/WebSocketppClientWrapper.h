...
namespace Internal {
    ...
    public:
        ...
        Aws::GameLiftServer::GenericOutcome Connect(const Uri &uri) override;
        Aws::GameLiftServer::GenericOutcome SendSocketMessage(const std::string& requestId, const std::string& message) override;
    ...
    private:
        ...
        Aws::GameLiftServer::GenericOutcome SendSocketMessageAsync(const std::string& message);
