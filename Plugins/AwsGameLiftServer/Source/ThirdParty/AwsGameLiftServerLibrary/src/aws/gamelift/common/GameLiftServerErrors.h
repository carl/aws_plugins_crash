...
{
    enum class AWS_GAMELIFTSERVER_API GAMELIFT_ERROR_TYPE
    {
    ...
    class AWS_GAMELIFTSERVER_API GameLiftServerError
    {
    ...
    public:
        ...
        GameLiftServerError() : m_errorType() {};

        ~GameLiftServerError(){};

        GameLiftServerError(const int statusCode, const std::string &message) :
                GameLiftServerError(GetErrorTypeForStatusCode(statusCode), message) {};

        GameLiftServerError(GAMELIFT_ERROR_TYPE errorType) : m_errorType(errorType)
            , m_errorName(Aws::GameLiftServer::GameLiftServerError::GetDefaultNameForErrorType(errorType))
            , m_errorMessage(Aws::GameLiftServer::GameLiftServerError::GetDefaultMessageForErrorType(errorType))
        {};

        GameLiftServerError(GAMELIFT_ERROR_TYPE errorType, const std::string& errorName, const std::string& message) :
            m_errorType(errorType), m_errorName(errorName), m_errorMessage(message) {};

        GameLiftServerError(GAMELIFT_ERROR_TYPE errorType, const std::string& message) :
            m_errorType(errorType),
            m_errorName(Aws::GameLiftServer::GameLiftServerError::GetDefaultNameForErrorType(errorType)),
            m_errorMessage(message) {};

        GameLiftServerError(const GameLiftServerError& rhs) :
            m_errorType(rhs.GetErrorType()), m_errorName(rhs.GetErrorName()), m_errorMessage(rhs.GetErrorMessage()) {};

        bool operator ==(const GameLiftServerError other) const {
 ...
 public:
    ...
    GameLiftServerError(const int statusCode, const char* message) :
            GameLiftServerError(GetErrorTypeForStatusCode(statusCode), message) {};
     ...
     GameLiftServerError(GAMELIFT_ERROR_TYPE errorType)
     {
         Init(errorType,
             Aws::GameLiftServer::GameLiftServerError::GetDefaultNameForErrorType(errorType),
             Aws::GameLiftServer::GameLiftServerError::GetDefaultMessageForErrorType(errorType));
     };

     GameLiftServerError(GAMELIFT_ERROR_TYPE errorType, const char* errorName, const char* message) :
         m_errorType(errorType)
     {
     ...
     GameLiftServerError(GAMELIFT_ERROR_TYPE errorType, const char* message)
     {
         Init(errorType,
             Aws::GameLiftServer::GameLiftServerError::GetDefaultNameForErrorType(errorType),
             message);
