...
#include <aws/gamelift/common/GameLiftServerErrors.h>
...
namespace Server
{
    ...
    typedef Aws::GameLiftServer::Outcome<Aws::GameLiftServer::Internal::GameLiftServerState*, GameLiftServerError> InitSDKOutcome;
    typedef Aws::GameLiftServer::Outcome<std::vector<std::string>, GameLiftServerError> GetExpectedPlayerSessionIDsOutcome;
    typedef Aws::GameLiftServer::Outcome<std::vector<std::string>, GameLiftServerError> GetConnectedPlayerSessionIDsOutcome;

    /**
    @return The current SDK version.
    */
    AWS_GAMELIFTSERVER_API AwsStringOutcome GetSdkVersion();
    ...
    */
    AWS_GAMELIFTSERVER_API InitSDKOutcome InitSDK(const Aws::GameLiftServer::Server::Model::ServerParameters & serverParameters);
    ...
    */
    AWS_GAMELIFTSERVER_API GenericOutcome ProcessReady(const Aws::GameLiftServer::Server::ProcessParameters &processParameters);
    ...
    */
    AWS_GAMELIFTSERVER_API GenericOutcome ProcessEnding();
    ...
    */
    AWS_GAMELIFTSERVER_API GenericOutcome ActivateGameSession();
    ...
    */
    AWS_GAMELIFTSERVER_API StartMatchBackfillOutcome StartMatchBackfill(const Aws::GameLiftServer::Server::Model::StartMatchBackfillRequest &startMatchBackfillRequest);

    /**
    Reports to GameLift that we need to stop a request to backfill a match using FlexMatch.
    */
    AWS_GAMELIFTSERVER_API GenericOutcome StopMatchBackfill(const Aws::GameLiftServer::Server::Model::StopMatchBackfillRequest &request);

    /**
    update player session policy on the GameSession 
    */
    AWS_GAMELIFTSERVER_API GenericOutcome UpdatePlayerSessionCreationPolicy(Aws::GameLiftServer::Server::Model::PlayerSessionCreationPolicy newPlayerSessionPolicy);

    /**
        @return The server's bound GameSession Id, if the server is Active.
     */
    AWS_GAMELIFTSERVER_API AwsStringOutcome GetGameSessionId();
    ...
    */
    AWS_GAMELIFTSERVER_API AwsLongOutcome GetTerminationTime();
     ...
     */
    AWS_GAMELIFTSERVER_API GenericOutcome AcceptPlayerSession(const std::string& playerSessionId);
    ...
    /**
        ...
        @param playerSessionId the ID of the joining player's session.
     */
    AWS_GAMELIFTSERVER_API GenericOutcome RemovePlayerSession(const std::string& playerSessionId);
    ...
    */
    AWS_GAMELIFTSERVER_API DescribePlayerSessionsOutcome DescribePlayerSessions(const Aws::GameLiftServer::Server::Model::DescribePlayerSessionsRequest &describePlayerSessionsRequest);
    ...
    */
    ...
    @return Pointer to the internal server state for use with InitializeWithExisting().
    */
    AWS_GAMELIFTSERVER_API GenericOutcome InitSDK(const Aws::GameLiftServer::Server::Model::ServerParameters &serverParameters);
    ...
    */
    ...
    @param playerSessionId the ID of the joining player's session.
    */
    AWS_GAMELIFTSERVER_API GenericOutcome AcceptPlayerSession(const char* playerSessionId);
    ...
    @param playerSessionId the ID of the joining player's session.
    */
    AWS_GAMELIFTSERVER_API GenericOutcome RemovePlayerSession(const char* playerSessionId);
    ...
    */
    AWS_GAMELIFTSERVER_API GenericOutcome Destroy();
    ...
    */
    AWS_GAMELIFTSERVER_API GetComputeCertificateOutcome GetComputeCertificate();

    /**
     * Retrieves the instance role credentials for the host on managed EC2. Returns an
     * error for customer managed hardware.
     */
    AWS_GAMELIFTSERVER_API GetFleetRoleCredentialsOutcome GetFleetRoleCredentials(const Aws::GameLiftServer::Server::Model::GetFleetRoleCredentialsRequest &request);
