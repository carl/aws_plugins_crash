...
namespace Internal {
    ...
    public:
        ...
        static Aws::GameLiftServer::Server::LogParameters SafelyDeserializeLogParameters(const rapidjson::Value& value,
                const char* key);
        static void WriteLogParameters(rapidjson::Writer<rapidjson::StringBuffer>* writer, const char* key,
                const Aws::GameLiftServer::Server::LogParameters& value);
    };
