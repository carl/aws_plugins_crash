...
namespace Internal
{
    using namespace Aws::GameLiftServer::Server::Model;

#ifndef GAMELIFT_USE_STD
    typedef Outcome<GameLiftServerState*, GameLiftServerError> InitSDKOutcome;
#endif
    ...
    public:
        ...
        GenericOutcome ProcessReady(const Aws::GameLiftServer::Server::ProcessParameters& processParameters);

        GenericOutcome ProcessEnding();

        GenericOutcome InitializeNetworking(const Aws::GameLiftServer::Server::Model::ServerParameters& serverParameters);
        ...
        DescribePlayerSessionsOutcome DescribePlayerSessions(const Aws::GameLiftServer::Server::Model::DescribePlayerSessionsRequest& describePlayerSessionsRequest);

        StartMatchBackfillOutcome StartMatchBackfill(const Aws::GameLiftServer::Server::Model::StartMatchBackfillRequest& startMatchBackfillRequest);

        GenericOutcome StopMatchBackfill(const Aws::GameLiftServer::Server::Model::StopMatchBackfillRequest& stopMatchBackfillRequest);
    ...
    public:
        ...
        StartMatchBackfillOutcome StartMatchBackfill(const Aws::GameLiftServer::Server::Model::StartMatchBackfillRequest& request);

        GenericOutcome StopMatchBackfill(const Aws::GameLiftServer::Server::Model::StopMatchBackfillRequest& request);
    ...
    private:
        std::function<void(Aws::GameLiftServer::Server::Model::GameSession, void*)> m_onStartGameSession;
        std::function<void(Aws::GameLiftServer::Server::Model::UpdateGameSession, void*)> m_onUpdateGameSession;
...
#endif
        public:
            GetFleetRoleCredentialsOutcome GetFleetRoleCredentials(const Aws::GameLiftServer::Server::Model::GetFleetRoleCredentialsRequest& request);
