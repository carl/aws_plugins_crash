...
namespace PlayerSessionStatusMapper
{
  ...
  inline AWS_GAMELIFTSERVER_API PlayerSessionStatus GetPlayerSessionStatusForName(const std::string& name)
  {
      if (name == "RESERVED") {
  ...
  inline AWS_GAMELIFTSERVER_API std::string GetNameForPlayerSessionStatus(PlayerSessionStatus value)
  {
      switch (value) {
...
#else
  inline AWS_GAMELIFTSERVER_API PlayerSessionStatus GetPlayerSessionStatusForName(const char* name)
  {
  ...
  inline AWS_GAMELIFTSERVER_API const char* GetNameForPlayerSessionStatus(PlayerSessionStatus value)
  {
      switch (value) {
          case PlayerSessionStatus::RESERVED:
              return "RESERVED";
