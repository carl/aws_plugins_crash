        ...
        namespace Server
        {
            namespace Model
            {
                ...
                namespace UpdateReasonMapper
                {
                    ...
                    inline AWS_GAMELIFTSERVER_API UpdateReason GetUpdateReasonForName(const std::string& s_name) {
                        const char* name = s_name.c_str();
#else
                    inline AWS_GAMELIFTSERVER_API UpdateReason GetUpdateReasonForName(const char* name) {
#endif
...
#ifdef GAMELIFT_USE_STD
                    inline AWS_GAMELIFTSERVER_API std::string GetNameForUpdateReason(UpdateReason value)
#else
                    inline AWS_GAMELIFTSERVER_API const char* GetNameForUpdateReason(UpdateReason value)
#endif
                    {
                        switch (value)
                        {
